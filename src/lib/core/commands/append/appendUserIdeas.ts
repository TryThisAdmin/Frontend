...
/**
 * Appends IdeaPreviews to the USER_IDEAS_STORE
 ...
 */
export function appendUserIdeasCommand(
	uid: string,
	limit = 0,
	offset = 0,
	then: () => void = null
	...
	const success = (data: { entries: RAW_IdeaPreview[] }) => {
		USER_IDEAS_STORE.update((ideas) => [...ideas, ...data.entries.map((e) => mapIdeaPreview(e))]);
