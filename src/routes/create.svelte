<script lang="ts">
	...
	import { ERROR_MESSAGE_STORE, TAG_STORE, TOKEN_STORE } from "$lib/core/stores";
	...
	function cancle() {
		if (confirm("Do you really want to quit?")) window.history.back();
	}
	...
	function postIdea() {
		...
		// post idea
		Commands.createIdea(title, content, tags, () => {
			goto("/my-ideas");
		});
	}
	...
	<div class="container-fluid p-3 card shadow border">
		...
		<div class="p-3 form-group d-flex flex-column gap-3 border rounded">
			...
			<div class="d-flex justify-content-end align-items-center gap-3">
				<button type="button" class="btn btn-primary" on:click={postIdea}>
