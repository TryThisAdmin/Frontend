...
<template>
	<div class="container-fluid p-3 card shadow border">
		...
		<p>Legalesischer Abwehrzauber</p>

		<p>Angaben gemäß § 5 TMG, rechtliches Yadda-Yadda.</p>

		<h3>Kontakt:</h3>
		<p>
			TryThis Projektgruppe<br />
			E-Mail: ProjektInformatik.TryThis@gmail.com
		</p>

		<h3>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:</h3>
		<p>TryThis Projektgruppe</p>
		...
		<p>
			Eine weitergehende Verantwortung für möglicherweise nach Nutzung der vom Seitenbetreiber
			erstellten Inhalte auftretende Befindlichkeiten allgemeinen Unwohlseins wie insbesondere
			pessimistische Verstimmungen, Identitätskrisen oder durch Ablehnung der vertretenen Meinungen
			und Ansichten ursächliches Magengrimmen weist der Seitenbetreiber ausdrücklich zurück.
		</p>

		<p>Quelle: Impressum Generator von Rechtsanwältin Franziska Hasselbach</p>
	</div>
</template>
